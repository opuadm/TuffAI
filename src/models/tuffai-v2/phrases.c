...
const char *v2_knowledge_search(const KnowledgeCategory *cat, const char *keyword) {
    ...
    if (!cat || cat->count <= 0 || !keyword) return v2_knowledge_random(cat);

    klen = (int)strlen(keyword);
    if (klen <= 0) return v2_knowledge_random(cat);
    ...
    if (best) return best;
    return v2_knowledge_random(cat);
}
...
const char *v2_knowledge_random_any(void) {
    ...
    pick = rand() % 5;
    switch (pick) {
    case 0: return v2_knowledge_random(&v2_know_tech);
    case 1: return v2_knowledge_random(&v2_know_general);
    case 2: return v2_knowledge_random(&v2_know_phrases_en);
    case 3: return v2_knowledge_random(&v2_know_extra);
    default: return v2_knowledge_random(&v2_know_tech);
    }
}
...
const char *v2_knowledge_random_code(void) {
    ...
    pick = rand() % 4;
    switch (pick) {
    case 0: return v2_knowledge_random(&v2_know_code_c);
    case 1: return v2_knowledge_random(&v2_know_code_py);
    case 2: return v2_knowledge_random(&v2_know_code_js);
    default: return v2_knowledge_random(&v2_know_code_misc);
    }
}
...
const char *v2_knowledge_random_phrase(void) {
    ...
    pick = rand() % 4;
    switch (pick) {
    case 0: return v2_knowledge_random(&v2_know_phrases_en);
    case 1: return v2_knowledge_random(&v2_know_phrases_pl);
    case 2: return v2_knowledge_random(&v2_know_phrases_ru);
    default: return v2_knowledge_random(&v2_know_phrases_zh);
    }
}
