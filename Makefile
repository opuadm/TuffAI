...
V3_DATA_SRCS = $(SRCDIR)/models/tuffai-v3/tech.c $(SRCDIR)/models/tuffai-v3/languages.c $(SRCDIR)/models/tuffai-v3/code.c $(SRCDIR)/models/tuffai-v3/general.c $(SRCDIR)/models/tuffai-v3/phrases.c $(SRCDIR)/models/tuffai-v3/vocab.c $(SRCDIR)/models/tuffai-v3/extra.c $(SRCDIR)/models/tuffai-v3/opinions.c $(SRCDIR)/models/tuffai-v3/topics.c $(SRCDIR)/models/tuffai-v3/retrieval.c $(SRCDIR)/models/tuffai-v3/code_mode.c
V3_ENGINE_SRCS = $(SRCDIR)/models/tuffai-v3/engine/engine.c $(SRCDIR)/models/tuffai-v3/engine/corpus.c
...
ifneq ($(findstring v3,$(MODELS)),)
CFLAGS += -DENABLE_TUFFAI_V3
V3_DATA_OBJS = $(patsubst $(SRCDIR)/models/tuffai-v3/%.c,$(BUILDDIR)/models/tuffai-v3/%.o,$(V3_DATA_SRCS))
V3_ENGINE_OBJS = $(patsubst $(SRCDIR)/models/tuffai-v3/engine/%.c,$(BUILDDIR)/models/tuffai-v3/engine/%.o,$(V3_ENGINE_SRCS))
MODEL_OBJS += $(V3_DATA_OBJS) $(V3_ENGINE_OBJS)
BUILD_DIRS += $(BUILDDIR)/models/tuffai-v3/engine
endif
...
$(BUILDDIR)/models/tuffai-v3/%.o: $(SRCDIR)/models/tuffai-v3/%.c | $(BUILDDIR)
	$(CC) $(CFLAGS) -c -o $@ $<

$(BUILDDIR)/models/tuffai-v3/engine/%.o: $(SRCDIR)/models/tuffai-v3/engine/%.c | $(BUILDDIR)
	$(CC) $(CFLAGS) -c -o $@ $<
